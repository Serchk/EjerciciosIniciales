...
public class Ejercicio4_5 : MonoBehaviour
{
    ...
    string Convertir(float cantidad, string moneda)
    {
        if (moneda == "euro")
        {
            ...
            string conversion = "4.5 || " + cantidad + " euros son " + convertirADolar + " dolares.";
            return conversion;
        }
        else if (moneda == "dolares")
        {
            float convertirAEuro = cantidad * 0.90009557f;
            string conversion = "4.5 || " + cantidad + "dolares son " + convertirAEuro + " euros.";
            return conversion;
        }
        else
        {
            string conversion = "4.5 || Indica la moneda para poder hacer la conversión(euro o dolar)";
            return conversion;
        }
    }
}
